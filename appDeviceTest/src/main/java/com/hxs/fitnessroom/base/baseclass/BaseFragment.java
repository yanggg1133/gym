...
public class BaseFragment extends Fragment
{
     ...
     * @see #onCloseAnAccount()
     */
    public void registerNewMessageBroadcastReceiver()
    {
        try
        {
            if (null != mNewMessageBroadcastReceiver)
                getBaseActivity().unregisterReceiver(mNewMessageBroadcastReceiver);
        } catch (Exception e)
        {
            //预防某种未情况引发的异常
        }
        ...
        getBaseActivity().registerReceiver(mNewMessageBroadcastReceiver,new IntentFilter(MessageReceiver.ReceiverNewMessageKey));
    }
    ...
    public void onDestroy()
    {
        ...
        {
            getBaseActivity().unregisterReceiver(mNewMessageBroadcastReceiver);
            mNewMessageBroadcastReceiver = null;
        }
    }
}
