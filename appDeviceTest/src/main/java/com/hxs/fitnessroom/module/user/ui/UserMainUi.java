...
public class UserMainUi extends BaseUi
{
    ...
    private void initView()
    {
        ...
        if(MessageReceiver.isHasNewMessage(getBaseFragment().getContext()))
            showNewMessage();
    }
    ...
    {
        setting_reserve.showNewMessageIcon();
        ((MainActivity)getBaseFragment().getActivity()).showNewMessageIcon(true);
    }
    public void hideNewMessage()
    {
        setting_reserve.hideNewMessageIcon();
        ((MainActivity)getBaseFragment().getActivity()).showNewMessageIcon(false);
        MessageReceiver.setNewMessage(getBaseFragment().getContext(),false);
    }
}
