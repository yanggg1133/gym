...
public abstract class ParamsBuilder
{
    ...
    static class FormParamsBuilder extends  ParamsBuilder
    {
        ...
        @Override
        public ParamsBuilder putParam(String key,@Nullable Object value)
        {
            params.append(paramsSeparator_1).append(key).append(paramsSeparator_2).append(value == null ? "" : value);
            return this;
        }
